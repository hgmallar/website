    ...
    <div className="row justify-content-center width">
      <div id="content" className="col-md-10 bg-white">
        <ul className="lead hex">
          <li>
            Full-stack web developer and experienced verification engineer with
            additional background as a high school math and computer science
            teacher.
          </li>
          <li>
          ...
          <li>
            ...
            Javascript, jQuery, Node, React.js, Express, MySQL, and MongoDB, as
            well as Java, C, and C++.
          </li>
          <li>
